package org.crazyit.cfgProject3_4_2;
		...
		bn.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View source)
			{
				...
				if (config.orientation == Configuration.ORIENTATION_LANDSCAPE)
				{
					...
					String screen = new Configuration().orientation ==
							Configuration.ORIENTATION_LANDSCAPE ? "横向屏幕" : "竖向屏幕";
					Toast.makeText(ChangeCfg.this, screen, Toast.LENGTH_SHORT).show();
				}
				// 如果当前是竖屏
				if (config.orientation == Configuration.ORIENTATION_PORTRAIT)
				{
					...
					String screen = new Configuration().orientation == Configuration.ORIENTATION_LANDSCAPE ? "横向屏幕":"竖向屏幕";
					Toast.makeText(ChangeCfg.this, screen, Toast.LENGTH_SHORT).show();
				}
			}
		});
