...
class HitMouseFrame2 extends JFrame implements Runnable 
{
     ...
     public HitMouseFrame2() 
      {      super();
             ...
             this.setTitle("非一般的打地鼠之再战雪原");                   //设置窗体标题
             ...
             classJLabel=new JLabel("关卡 2：再战雪原");            
             int i=0;
      	  ...
      	  mouses[0].setLocation(55,135);                //设置每个标签的位置
          ...
          {    	int index1=(int)(Math.random()*4); 
				...
				switch (index1)
				{
					...
					case 3:  { mouses[index].setIcon(new ImageIcon("./image/地鼠3.png"));    //为该标签添加地鼠图片
					           k++;
					break;  }
					case 4:  { mouses[index].setIcon(new ImageIcon("./image/地鼠4.png"));    //为该标签添加地鼠图片
					           k++;
					break;  }
					default:
						         break;
		   ...
		   if (score>=100)	
        	{   
			    ...
			    JOptionPane.showMessageDialog(null, "恭喜进入下一关");
      	        ...
      	        frame3.setVisible(true);             //显示窗体	        
      	        new Thread(frame3).start();          //启动线程     
